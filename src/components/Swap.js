...
const Swap = () => {
    ...
    const [price, setPrice] = useState(0) // Hook for price

    const [showAlert, setShowAlert] = useState(false) // Hook for alert
    ...
    const getPrice = async () => {  // placing price for Exchange Rate in component state
        if (inputToken === outputToken) {
            setPrice(0)
            return
        }
                    ...
                    <Form onSubmit={swapHandler} style={{ maxWidth: '450px', margin: '50px auto' }}>
                        <Row className='my-3'>
                            ...
                            <InputGroup>
                               ...
                               >
                                <Dropdown.Item onClick={(e) => setInputToken(e.target.innerHTML)} >SOB</Dropdown.Item>
                        ...
                        <div className='d-flex justify-content-between'>
                            ...
                            <InputGroup>
                               ...
                               >
                                <Dropdown.Item onClick={(e) => setOutputToken(e.target.innerHTML)}>SOB</Dropdown.Item>
